...
public class AnnouncementDao {
    ...
    public List<Announcement> selectAllAnnouncements() {
        final String sql = "SELECT announcement_id, course_id, date, announcement_text FROM announcement";
        List<Announcement> announcements = jdbcTemplate.query(sql, (resultSet, i) -> {
            ...
            String announcement_text = resultSet.getString("announcement_text");
    ...
    public Optional<Announcement> selectAnnouncementByCourseId(String CourseId) {
        final String sql = "SELECT announcement_id, announcement_name, date, announcement_description FROM announcement WHERE course_id = ?";
